...
KCP_MTU=${KCP_MTU}
./client_linux_amd64 -r $SERVER_LINK -l ":$KCP_LOCAL_LISTEN_PORT" --key $KCP_KEY --crypt $KCP_CLIENT_CRYPT -mode $KCP_LOCAL_MODE --mtu $KCP_MTU --rcvwnd $KCP_CLIENT_RCVWND --nocomp
